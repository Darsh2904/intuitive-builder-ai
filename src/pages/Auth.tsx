...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-background/50 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md relative bg-background/80 backdrop-blur-sm border-border/50">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold">Welcome to CrackIt AI</CardTitle>
          <CardDescription>
